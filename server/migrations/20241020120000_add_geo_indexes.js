exports.up = async function (knex) {
  ...
  await knex.raw('CREATE INDEX IF NOT EXISTS idx_driver_locations_location_gist ON driver_locations USING GIST (location)');
};

exports.down = async function (knex) {
  await knex.raw('DROP INDEX IF EXISTS idx_driver_locations_location_gist');
